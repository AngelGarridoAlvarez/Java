...
/*
 Escriba un programa que te permita jugar a la “primitiva”.  Para facilitar la labor depuración de errores, cada vez que el usuario introduzca un número se mostrará el boleto con los números que debe acertar.
...
Ayuda: Para crear un número aleatorio en Java: int valor = Math.floor(Math.random()*99+10);
 */
...
public class Ejercicio124 {
    public static void main(String[] args) {
        ...
        while ((((motivacionAlumno / 8) * 100) <= 80) && (contador < 3) || contador == 2) {
            ...
            if (contador == 1) {
                System.out.println("El resultado del test es inferior al 80%, tienes que repetir dos veces mÃ¡s el test");
            } else if (contador == 2) {
