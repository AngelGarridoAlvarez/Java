...
public class EntradaSalidaConsola {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Dime tu nombre y te diré quién eres: ");
        ...
        String nombre = sc.nextLine(); //la variable nombre que es de tipo string la obtengo con el método nextLline de la clase Scanner que ha heredado el objeto sc
        ...
        System.out.println("El precio con IVA es " + precio * 1.21 + ", estás pagando al estado " + IvaRedondeado + "€");
